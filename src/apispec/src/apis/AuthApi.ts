...
export interface AuthOidcProviderLogoutGetRequest {
    provider: string;
    returnUrl?: string;
}
...
export class AuthApi extends runtime.BaseAPI {
     ...
     */
    async authOidcProviderLogoutGetRaw(requestParameters: AuthOidcProviderLogoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['provider'] == null) {
            throw new runtime.RequiredError(
                'provider',
                'Required parameter "provider" was null or undefined when calling authOidcProviderLogoutGet().'
            );
        }
        ...
        let urlPath = `/auth/oidc/{provider}/logout`;
        urlPath = urlPath.replace(`{${"provider"}}`, encodeURIComponent(String(requestParameters['provider'])));
     ...
     * Initiate OIDC logout
     */
    async authOidcProviderLogoutGet(requestParameters: AuthOidcProviderLogoutGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.authOidcProviderLogoutGetRaw(requestParameters, initOverrides);
    }
