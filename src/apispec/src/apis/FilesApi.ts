...
import {
    ...
    SuccessVolumeFileArchiveImportResponseFromJSON,
    SuccessVolumeFileArchiveImportResponseToJSON,
...
export interface ApiV1SandboxvolumesIdFilesArchivePutRequest {
    id: string;
    path: string;
    body: Blob;
}
...
export class FilesApi extends runtime.BaseAPI {
     ...
     */
    async apiV1SandboxvolumesIdFilesArchivePutRaw(requestParameters: ApiV1SandboxvolumesIdFilesArchivePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessVolumeFileArchiveImportResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling apiV1SandboxvolumesIdFilesArchivePut().'
            );
        }
        ...
        if (requestParameters['path'] == null) {
            throw new runtime.RequiredError(
                'path',
                'Required parameter "path" was null or undefined when calling apiV1SandboxvolumesIdFilesArchivePut().'
            );
        }
        ...
        if (requestParameters['body'] == null) {
            throw new runtime.RequiredError(
                'body',
                'Required parameter "body" was null or undefined when calling apiV1SandboxvolumesIdFilesArchivePut().'
            );
        }
        ...
        let urlPath = `/api/v1/sandboxvolumes/{id}/files/archive`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SuccessVolumeFileArchiveImportResponseFromJSON(jsonValue));
    }
     ...
     * Import a tar archive into a volume
     */
    async apiV1SandboxvolumesIdFilesArchivePut(requestParameters: ApiV1SandboxvolumesIdFilesArchivePutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessVolumeFileArchiveImportResponse> {
        const response = await this.apiV1SandboxvolumesIdFilesArchivePutRaw(requestParameters, initOverrides);
        return await response.value();
    }
