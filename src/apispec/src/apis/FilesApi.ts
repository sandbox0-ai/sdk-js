...
import {
    ...
    CloneVolumeFilesRequestFromJSON,
    CloneVolumeFilesRequestToJSON,
    ErrorEnvelopeFromJSON,
    ErrorEnvelopeToJSON,
    MoveFileRequestFromJSON,
    MoveFileRequestToJSON,
    SuccessCloneVolumeFilesResponseFromJSON,
    SuccessCloneVolumeFilesResponseToJSON,
...
export class FilesApi extends runtime.BaseAPI {
     ...
     */
    async apiV1SandboxvolumesIdFilesClonePostRaw(requestParameters: ApiV1SandboxvolumesIdFilesClonePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessCloneVolumeFilesResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling apiV1SandboxvolumesIdFilesClonePost().'
            );
        }
        ...
        if (requestParameters['cloneVolumeFilesRequest'] == null) {
            throw new runtime.RequiredError(
                'cloneVolumeFilesRequest',
                'Required parameter "cloneVolumeFilesRequest" was null or undefined when calling apiV1SandboxvolumesIdFilesClonePost().'
            );
        }
     ...
     * Clone files from sandbox volumes into a target volume
     */
    async apiV1SandboxvolumesIdFilesClonePost(requestParameters: ApiV1SandboxvolumesIdFilesClonePostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessCloneVolumeFilesResponse> {
