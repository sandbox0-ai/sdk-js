...
import {
    ...
    SuccessSandboxLogsResponseFromJSON,
    SuccessSandboxLogsResponseToJSON,
...
export class SandboxesApi extends runtime.BaseAPI {
     ...
     */
    async apiV1SandboxesIdLogsGetRaw(requestParameters: ApiV1SandboxesIdLogsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessSandboxLogsResponse>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SuccessSandboxLogsResponseFromJSON(jsonValue));
    }
     ...
     * Get sandbox pod logs
     */
    async apiV1SandboxesIdLogsGet(requestParameters: ApiV1SandboxesIdLogsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessSandboxLogsResponse> {
