...
import type { ProtocolRule } from './ProtocolRule';
import {
    ProtocolRuleFromJSON,
    ProtocolRuleFromJSONTyped,
    ProtocolRuleToJSON,
    ProtocolRuleToJSONTyped,
} from './ProtocolRule';
...
import type { EgressProxyPolicy } from './EgressProxyPolicy';
import {
    EgressProxyPolicyFromJSON,
    EgressProxyPolicyFromJSONTyped,
    EgressProxyPolicyToJSON,
    EgressProxyPolicyToJSONTyped,
} from './EgressProxyPolicy';
...
export function NetworkEgressPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): NetworkEgressPolicy {
    ...
    return {
        ...
        'protocolRules': json['protocolRules'] == null ? undefined : ((json['protocolRules'] as Array<any>).map(ProtocolRuleFromJSON)),
...
export function NetworkEgressPolicyToJSONTyped(value?: NetworkEgressPolicy | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'protocolRules': value['protocolRules'] == null ? undefined : ((value['protocolRules'] as Array<any>).map(ProtocolRuleToJSON)),
